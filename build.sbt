...
addCompilerPlugin("org.scalaz" %% "deriving-plugin" % derivingVersion cross CrossVersion.full)
libraryDependencies += "org.scalaz" %% "deriving-macro" % derivingVersion

val circeVersion = "0.12.2"
val derivingVersion = "2.0.0-M2"
